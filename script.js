            ...
            if (e.key === 'Enter') {
                ...
                if (terminalState === 'SHELL') {
                    ...
                    switch(cmd.toLowerCase()) {
                        case 'help': response = "Commands: projects, status, whoami, uplink, clear"; break;
                ...
                // --- STATE 2: UPLINK CONFIRMATION (Y/N) ---
                    ...
                    if (cmd.toLowerCase() === 'y' || cmd.toLowerCase() === 'yes') {
                        ...
                        window.location.href = `mailto:contact@philobyte.dev?subject=Secure Uplink&body=${encodeURIComponent(uplinkPayload)}`;
